CREATE SEQUENCE IF NOT EXISTS outbox_sequence START WITH 1 INCREMENT BY 1;

CREATE TABLE IF NOT EXISTS outbox_events (
    id              BIGINT          PRIMARY KEY DEFAULT nextval('outbox_sequence'),
    ...
    error_message   TEXT,
    CONSTRAINT fk_outbox_quote FOREIGN KEY (quote_id) REFERENCES quotes(id) ON DELETE SET NULL
);
